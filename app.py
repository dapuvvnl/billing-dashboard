...
def render_mr_analysis():
    ...
    # 🔥 FIX: include_lowest=True ensures avg_per_day=0 goes into '1-10' category
    ...
    agent_stats['category'] = pd.cut(
        ...
        labels=labels,
        right=True,
        include_lowest=True   # <--- यही line fix है
    )
    ...
    # Download button - category column ab sahi se aayega
