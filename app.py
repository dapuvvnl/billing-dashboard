...
def render_mr_analysis():
    ...
    agent_stats['category'] = pd.cut(
        ...
        labels=labels,
        right=True,
        include_lowest=True   # This ensures avg_per_day=0 goes into 'one to ten'
    )
    ...
    # Download button - Now category has English words, Excel will NOT convert them to dates!
